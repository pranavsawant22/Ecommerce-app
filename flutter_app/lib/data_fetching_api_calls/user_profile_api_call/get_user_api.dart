...
class GetUserAPI {
  static Future<dynamic> getUserAPICall() async {
    var response;
    var responseJson;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        sharedPreferences.setString("firstName", userData["firstName"]);
        sharedPreferences.setString("lastName", userData["lastName"]);
      }
    } on SocketException {
