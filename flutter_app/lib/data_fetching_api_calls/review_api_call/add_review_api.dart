...
class AddReviewAPI extends ChangeNotifier {
  String jwtToken = '';

  Future<bool> addReviewAPICall(
      String productId, String review, String skuid) async {
    String? lastName = "";
    String? firstName = "";
    ...
    try {
      var response = await http.post(
          Uri.parse(
              'https://auth-service-capstone.herokuapp.com/api/v1/rating-review/add-or-update-review'),
          headers: {
